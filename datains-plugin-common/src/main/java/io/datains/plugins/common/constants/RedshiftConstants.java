...
public class RedshiftConstants extends SQLConstants {
    ...
    public static final String KEYWORD_TABLE = DatasourceTypes.redshift.getKeywordPrefix() + "%s" + DatasourceTypes.redshift.getKeywordSuffix();

    public static final String KEYWORD_FIX = "%s." + DatasourceTypes.redshift.getKeywordPrefix() + "%s" + DatasourceTypes.redshift.getKeywordSuffix();
