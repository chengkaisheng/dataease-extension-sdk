...
public class EsSqlLConstants extends SQLConstants {
    public static final String KEYWORD_TABLE = DatasourceTypes.es.getKeywordPrefix() + "%s" + DatasourceTypes.es.getKeywordSuffix();

    public static final String KEYWORD_FIX = "%s." + DatasourceTypes.es.getKeywordPrefix() + "%s" + DatasourceTypes.es.getKeywordSuffix();
