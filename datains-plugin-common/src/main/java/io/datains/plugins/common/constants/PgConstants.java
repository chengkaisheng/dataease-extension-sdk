...
public class PgConstants extends SQLConstants {
    ...
    public static final String KEYWORD_TABLE = DatasourceTypes.pg.getKeywordPrefix() + "%s" + DatasourceTypes.pg.getKeywordSuffix();

    public static final String KEYWORD_FIX = "%s." + DatasourceTypes.pg.getKeywordPrefix() + "%s" + DatasourceTypes.pg.getKeywordSuffix();
