...
public class Db2Constants extends SQLConstants {
    ...
    public static final String KEYWORD_TABLE = DatasourceTypes.db2.getKeywordPrefix() + "%s" + DatasourceTypes.db2.getKeywordSuffix();

    public static final String KEYWORD_FIX = "%s." + DatasourceTypes.db2.getKeywordPrefix() + "%s" + DatasourceTypes.db2.getKeywordSuffix();
